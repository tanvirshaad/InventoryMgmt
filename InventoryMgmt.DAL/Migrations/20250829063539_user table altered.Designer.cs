...
namespace InventoryMgmt.DAL.Migrations
{
    ...
    [Migration("20250829063539_user table altered")]
    partial class usertablealtered
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InventoryMgmt.DAL.EF.TableModels.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 8, 29, 6, 35, 38, 735, DateTimeKind.Utc).AddTicks(6583),
                            Description = "Office equipment and devices",
                            Name = "Equipment",
                            UpdatedAt = new DateTime(2025, 8, 29, 6, 35, 38, 735, DateTimeKind.Utc).AddTicks(6585)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 8, 29, 6, 35, 38, 735, DateTimeKind.Utc).AddTicks(6587),
                            Description = "Office furniture and fixtures",
                            Name = "Furniture",
                            UpdatedAt = new DateTime(2025, 8, 29, 6, 35, 38, 735, DateTimeKind.Utc).AddTicks(6587)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2025, 8, 29, 6, 35, 38, 735, DateTimeKind.Utc).AddTicks(6588),
                            Description = "Books and publications",
                            Name = "Books",
                            UpdatedAt = new DateTime(2025, 8, 29, 6, 35, 38, 735, DateTimeKind.Utc).AddTicks(6588)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2025, 8, 29, 6, 35, 38, 735, DateTimeKind.Utc).AddTicks(6589),
                            Description = "Important documents and records",
                            Name = "Documents",
                            UpdatedAt = new DateTime(2025, 8, 29, 6, 35, 38, 735, DateTimeKind.Utc).AddTicks(6590)
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2025, 8, 29, 6, 35, 38, 735, DateTimeKind.Utc).AddTicks(6591),
                            Description = "Other miscellaneous items",
                            Name = "Other",
                            UpdatedAt = new DateTime(2025, 8, 29, 6, 35, 38, 735, DateTimeKind.Utc).AddTicks(6591)
                        });
                });
