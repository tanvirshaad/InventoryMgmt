...
namespace InventoryMgmt.DAL.Migrations
{
    ...
    [Migration("20250913094945_AddApiTokenToInventory")]
            ...
            modelBuilder.Entity("InventoryMgmt.DAL.EF.TableModels.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 9, 13, 9, 49, 43, 990, DateTimeKind.Utc).AddTicks(6475),
                            Description = "Office equipment and devices",
                            Name = "Equipment",
                            UpdatedAt = new DateTime(2025, 9, 13, 9, 49, 43, 990, DateTimeKind.Utc).AddTicks(6477)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 9, 13, 9, 49, 43, 990, DateTimeKind.Utc).AddTicks(6479),
                            Description = "Office furniture and fixtures",
                            Name = "Furniture",
                            UpdatedAt = new DateTime(2025, 9, 13, 9, 49, 43, 990, DateTimeKind.Utc).AddTicks(6479)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2025, 9, 13, 9, 49, 43, 990, DateTimeKind.Utc).AddTicks(6480),
                            Description = "Books and publications",
                            Name = "Books",
                            UpdatedAt = new DateTime(2025, 9, 13, 9, 49, 43, 990, DateTimeKind.Utc).AddTicks(6480)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2025, 9, 13, 9, 49, 43, 990, DateTimeKind.Utc).AddTicks(6481),
                            Description = "Important documents and records",
                            Name = "Documents",
                            UpdatedAt = new DateTime(2025, 9, 13, 9, 49, 43, 990, DateTimeKind.Utc).AddTicks(6482)
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2025, 9, 13, 9, 49, 43, 990, DateTimeKind.Utc).AddTicks(6482),
                            Description = "Other miscellaneous items",
                            Name = "Other",
                            UpdatedAt = new DateTime(2025, 9, 13, 9, 49, 43, 990, DateTimeKind.Utc).AddTicks(6483)
                        });
                });
